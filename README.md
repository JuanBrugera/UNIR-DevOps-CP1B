...
```bash
todo-list-aws$ pip install -r test/requirements.txt --user
# unit test
todo-list-aws$ python -m pytest test/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
todo-list-aws$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest test/integration -v
```
